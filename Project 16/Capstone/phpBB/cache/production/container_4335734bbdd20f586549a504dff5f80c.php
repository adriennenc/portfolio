...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000468f332e000056403b218bcd(
...
class phpbbtemplatetwiglexer_00000000468f332e000056403b218bcd extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ad6a3f4ca7ca515583064 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ad6a3f4ca7e2480317442 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ad6a3f4ca78d360647841 = array(
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, 'set_environment', array('env' => $env), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;

        return $this->valueHolder5ad6a3f4ca7ca515583064->set_environment($env);
    }
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;

        return $this->valueHolder5ad6a3f4ca7ca515583064->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;

        return $this->valueHolder5ad6a3f4ca7ca515583064->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 = $initializer;
    }
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, '__get', array('name' => $name), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;

        if (isset(self::$publicProperties5ad6a3f4ca78d360647841[$name])) {
            return $this->valueHolder5ad6a3f4ca7ca515583064->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ad6a3f4ca7ca515583064;
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, '__isset', array('name' => $name), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, '__unset', array('name' => $name), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;
    ...
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, '__clone', array(), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;

        $this->valueHolder5ad6a3f4ca7ca515583064 = clone $this->valueHolder5ad6a3f4ca7ca515583064;
    }

    public function __sleep()
    {
        $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, '__sleep', array(), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;

        return array('valueHolder5ad6a3f4ca7ca515583064');
    }
    ...
    {
        return $this->initializer5ad6a3f4ca7e2480317442;
    }
    ...
    {
        return $this->initializer5ad6a3f4ca7e2480317442 && ($this->initializer5ad6a3f4ca7e2480317442->__invoke($valueHolder5ad6a3f4ca7ca515583064, $this, 'initializeProxy', array(), $this->initializer5ad6a3f4ca7e2480317442) || 1) && $this->valueHolder5ad6a3f4ca7ca515583064 = $valueHolder5ad6a3f4ca7ca515583064;
    }
    ...
    {
        return null !== $this->valueHolder5ad6a3f4ca7ca515583064;
    }
    ...
    {
        return $this->valueHolder5ad6a3f4ca7ca515583064;
    }
